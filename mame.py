...
ap.add_argument("-t", "--times", type=int, default=5000, help="Packets per one connection")
ap.add_argument("-th", "--threads", type=int, default=5, help="Threads")
ap.add_argument("-mg", "--multiprocessing", type=int, default=1, help="Multiprocessing")
